...
EMAIL_FROM = "mymail61906@gmail.com"
try:
    APP_PASSWORD = gmail_app_password = dbutils.secrets.get(
    scope="gmail",
...
def high_value_alert_stream():
    ...
    return spark.readStream.table("fineguard.gold.high_value_transaction_alert")